...
본 프로젝트는 **Feature Engineering 중심의 실험 기반 모델 개선 과정**을 기록한 프로젝트이며,

**팀에서 합의한 공통 전처리 및 Feature 규칙**들을 하나씩 추가, 제거해온 실험과정을 남겨,

팀의 모델링에 있어서 팀의 실험중복을 방지 및 무엇이 효과가 있었는지, 팀의 모델링 디버깅에 기여하는 것이 목표이다.

---

**팀에서 합의한 공통 전처리 및 Feature 규칙**
...
시간변수
    시간단위는 주기형 
    주말과 공휴일 변수 추가
    month, day, hour, dayofweek 로 나누기
